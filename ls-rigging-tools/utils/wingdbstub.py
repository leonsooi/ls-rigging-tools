...
# On OS X this must be set to the Contents/MacOS directory within the Wing IDE
# application bundle (for example, /Applications/WingIDE5.app/Contents/MacOS)
WINGHOME = r"C:\Program Files (x86)\Wing IDE 5.0"
