...
def layer_brow(mll):
    ...
    jntInfs = [u'CT__brow_bnd',
            ...
            u'LT_mid_brow_bnd',
            u'LT_out_brow_bnd']
    periLocs = [u'RT_innerUpper_eyelid_pLoc',
                u'CT__noseBridge_pLoc',
                u'LT_innerUpper_eyelid_pLoc',
                u'LT_upper_eyelid_pLoc',
                u'LT_outerUpper_eyelid_pLoc',
                u'LT_outer_eyelid_pLoc',
                u'LT__temple_pLoc',
                u'LT_out_forehead_pLoc',
                u'LT_in_forehead_pLoc',
                u'RT_in_forehead_pLoc']
    ...
    maskInfs = [u'CT__noseBridge_bnd',
                u'LT_innerUpper_eyelid_bnd',
                u'LT_upper_eyelid_bnd',
                u'LT_outerUpper_eyelid_bnd',
                u'LT_outer_eyelid_bnd',
                u'LT__temple_bnd',
                u'LT_out_forehead_bnd',
                u'LT_in_forehead_bnd',
                u'RT_in_forehead_bnd']
    layerInfo = 'Brow', jntInfs, inMaskInfs, maskInfs
    layer_weighting.buildLayer(mll, layerInfo)
...
def layer_nose(mll):
    ...
    jntInfs = [u'CT__noseBridge_bnd',
                u'CT__noseTip_bnd',
                u'LT__nostril_bnd']
    maskInfs = [u'CT__brow_bnd',
                u'LT_in_brow_bnd',
                u'LT_inner_eyelid_bnd',
                u'LT_in_cheek_bnd',
                u'LT_up_crease_bnd',
                u'LT__philtrum_bnd',
                u'LT_in_philtrum_bnd',
                u'RT_in_philtrum_bnd']
    layerInfo = 'Nose', jntInfs, jntInfs, maskInfs
    layer_weighting.buildLayer(mll, layerInfo)
