...
Updates:
- Create control curves using a class object
- Add middle spine shaper control
- Added deformation system into script, but in separate proc
'''
